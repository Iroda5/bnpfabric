...
const Yuz = () => {
  ...
  const bed : {id:number, img:string, name:string}[] = [
  ...
  return (
    <div className="yuz" >
        <div className="yuz__conta" >
            <div className="yuz__mat" >
                <h1 className="yuz__foiz" data-aos="fade-up">100%</h1>
                <p className="yuz__sif" data-aos="fade-up">Material sifati</p>
            </div>
            <img className="yuz__pic" src="https://www.bnpfabric.uz/wp-content/uploads/2024/02/111.png" alt="" />
            <div className="yuz__bux">
                <h1 className="yuz__tab" data-aos="fade-up">"Buxoro Tabiiy Mahsuloti"</h1>
                <p className="yuz__kop" data-aos="fade-up">Ko'p yillar davomida butun dunyoda foydalanish uchun paxta matolarini ishlab chiqaradigan kompaniya bo'lib kelgan</p>
                <button onClick={bedsHandler} className="yuz__btn">To'plam</button>
            </div>
        </div>
    </div>
  )
